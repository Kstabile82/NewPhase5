...
function Questions({ i, questions, setQuestions, addOpt, setAddOpt, opts, setOpts, question, setQuestion }) {
    ...
    function handleSaveNewOption(e) {
        e.preventDefault();
        console.log(newOptionInput, correctAnswer, question.id)
        setAddOpt(false)
        //post request option text = newOptionInput, correct = correctAnswer, question_id = qn.id
    }
    return (
        <div>
